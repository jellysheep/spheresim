...
int circlesCount = 3;
int showCirclesCount = std::min(2048,circlesCount);
bool manyCircles = (showCirclesCount>20);

vector3 boxSize = (vector3){1,1,1};
vector2 size = (vector2){0.01,0.1};
...
scalar E = 5*5*2*1000000*0.05;//((200)/1000000.0)/2; //Silikonkautschuk
scalar poisson = 0.5; //Gummi
scalar elastic = 1.0;//0.7;//0.05;//0.9;//0.999;//0.9;
